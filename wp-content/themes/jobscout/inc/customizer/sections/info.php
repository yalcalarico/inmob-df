...
if ( ! function_exists( 'jobscout_customizer_theme_info' ) ) :
	...
	function jobscout_customizer_theme_info( $wp_customize ) {
		...
		$theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'jobscout' ), esc_url( __( 'https://demo.rarathemes.com/jobscout/', 'jobscout' ) ), esc_html__( 'Click here.', 'jobscout' ) );
