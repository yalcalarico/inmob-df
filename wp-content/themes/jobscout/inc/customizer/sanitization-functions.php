...
function jobscout_sanitize_select( $value ){    
    if ( is_array( $value ) ) {
...
function jobscout_sanitize_number_floatval( $number, $setting ) {
...
function jobscout_sanitize_image( $image, $setting ) {
    /*
...
function jobscout_sanitize_sortable( $value = array() ) {
...
function jobscout_sanitize_code( $value ){
