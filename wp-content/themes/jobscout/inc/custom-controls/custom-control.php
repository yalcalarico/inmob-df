...
function jobscout_register_custom_controls( $wp_customize ){    
    ...
    $wp_customize->register_control_type( 'JobScout_Code_Control' );
    $wp_customize->register_control_type( 'JobScout_Radio_Buttonset_Control' );
    $wp_customize->register_control_type( 'JobScout_Radio_Image_Control' );
    $wp_customize->register_control_type( 'JobScout_Select_Control' );
