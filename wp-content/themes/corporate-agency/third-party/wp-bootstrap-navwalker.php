<?php
/**
 * Corporate_Agency Bootstrap Navwalker
 *
 * @package Corporate_Agency-Bootstrap-Navwalker
 */

/**
 * Class Name: Corporate_Agency_Bootstrap_Navwalker
 * Plugin Name: Corporate_Agency Bootstrap Navwalker
 * Plugin URI:  https://github.com/wp-bootstrap/wp-bootstrap-navwalker
 * Description: A custom WordPress nav walker class to implement the Bootstrap 3 navigation style in a custom theme using the WordPress built in menu manager.
 * Author: Edward McIntyre - @twittem, Corporate_Agency Bootstrap, William Patton - @pattonwebz
 * Version: 3.1.0
...
if ( ! class_exists( 'Corporate_Agency_Bootstrap_Navwalker' ) ) {
	/**
	 * Corporate_Agency_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class Corporate_Agency_Bootstrap_Navwalker extends Walker_Nav_Menu {
